...
INSTALL_DIR="$PROJECT_ROOT/install/mathOp"
FMT_HEADERS_LOCATION="$DEPS_DIR/fmt/include"
CONANFILE_LOCATION="$PROJECT_ROOT/conan/conanfiles/ios/conanfile.txt"
CONAN_PROFILE_LOCATION="$PROJECT_ROOT/conan/profiles/conan-profile-ios.txt"
